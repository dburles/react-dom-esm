...
import "./ReactDOMClientInjection.js";
import { computeUniqueAsyncExpiration, findHostInstanceWithNoPortals, updateContainerAtExpirationTime, flushRoot, createContainer, updateContainer, batchedUpdates, unbatchedUpdates, interactiveUpdates, flushInteractiveUpdates, flushSync, flushControlled, injectIntoDevTools, getPublicRootInstance, findHostInstance, findHostInstanceWithWarning } from "../react-reconciler/inline.dom.js";
import { createPortal as createPortalImpl } from "../react-shared/ReactPortal.js";
import { canUseDOM } from "../react-shared/ExecutionEnvironment.js";
import { setBatchingImplementation } from "../react-events/ReactGenericBatching.js";
import { setRestoreImplementation, enqueueStateRestore, restoreStateIfNeeded } from "../react-events/ReactControlledComponent.js";
import { injection as EventPluginHubInjection, runEventsInBatch } from "../react-events/EventPluginHub.js";
import { eventNameDispatchConfigs } from "../react-events/EventPluginRegistry.js";
import { accumulateTwoPhaseDispatches, accumulateDirectDispatches } from "../react-events/EventPropagators.js";
import { has as hasInstance } from "../react-shared/ReactInstanceMap.js";
...
import { enableStableConcurrentModeAPIs } from "../react-shared/ReactFeatureFlags.js";
import { getInstanceFromNode, getNodeFromInstance, getFiberCurrentPropsFromNode, getClosestInstanceFromNode } from "./ReactDOMComponentTree.js";
...
setBatchingImplementation(batchedUpdates, interactiveUpdates, flushInteractiveUpdates);
...
const ReactDOM = {
  ...
  __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: {
    ...
    Events: [getInstanceFromNode, getNodeFromInstance, getFiberCurrentPropsFromNode, EventPluginHubInjection.injectEventPluginsByName, eventNameDispatchConfigs, accumulateTwoPhaseDispatches, accumulateDirectDispatches, enqueueStateRestore, restoreStateIfNeeded, dispatchEvent, runEventsInBatch]
  }
};
