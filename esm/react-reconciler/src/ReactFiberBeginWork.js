...
import { debugRenderPhaseSideEffects, debugRenderPhaseSideEffectsForStrictMode, enableProfilerTimer, enableSuspenseServerRenderer } from "../../react-shared/ReactFeatureFlags.js";
import invariant from "../../react-shared/invariant.js";
import shallowEqual from "../../react-shared/shallowEqual.js";
...
import { refineResolvedLazyComponent } from "../../react-shared/ReactLazyComponent.js";
import { REACT_LAZY_TYPE } from "../../react-shared/ReactSymbols.js";
import warning from "../../react-shared/warning.js";
import warningWithoutStack from "../../react-shared/warningWithoutStack.js";
import { setCurrentPhase, getCurrentFiberOwnerNameInDevOrNull, getCurrentFiberStackInDev } from "./ReactCurrentFiber.js";
...
import { ConcurrentMode, NoContext, ProfileMode, StrictMode } from "./ReactTypeOfMode.js";
import { shouldSetTextContent, shouldDeprioritizeSubtree } from "./ReactFiberHostConfig.js";
import { pushHostContext, pushHostContainer } from "./ReactFiberHostContext.js";
import { pushProvider, propagateContextChange, readContext, prepareToReadContext, calculateChangedBits } from "./ReactFiberNewContext.js";
...
import { getMaskedContext, getUnmaskedContext, hasContextChanged as hasLegacyContextChanged, pushContextProvider as pushLegacyContextProvider, isContextProvider as isLegacyContextProvider, pushTopLevelContextObject, invalidateContextProvider } from "./ReactFiberContext.js";
import { enterHydrationState, reenterHydrationStateFromDehydratedSuspenseInstance, resetHydrationState, tryToClaimNextHydratableInstance } from "./ReactFiberHydrationContext.js";
import { adoptClassInstance, applyDerivedStateFromProps, constructClassInstance, mountClassInstance, resumeMountClassInstance, updateClassInstance } from "./ReactFiberClassComponent.js";
import { readLazyComponentType, resolveDefaultProps } from "./ReactFiberLazyComponent.js";
import { resolveLazyComponentTag, createFiberFromTypeAndProps, createFiberFromFragment, createWorkInProgress, isSimpleFunctionComponent } from "./ReactFiber.js";
...
function updateSuspenseComponent(current, workInProgress, renderExpirationTime) {
  ...
  const nextProps = workInProgress.pendingProps; // We should attempt to render the primary children unless this boundary
  ...
  let child; // `next` points to the next fiber React should render. In the normal case,
  ...
  if (current === null) {
    ...
    if (prevDidTimeout) {
      ...
      if (nextDidTimeout) {
        ...
        const fallbackChildFragment = primaryChildFragment.sibling = createWorkInProgress(currentFallbackChildFragment, nextFallbackChildren, currentFallbackChildFragment.expirationTime);
      ...
      if (nextDidTimeout) {
        ...
        primaryChildFragment.child = currentPrimaryChild; // Even though we're creating a new fiber, there are no new children,
        ...
        const fallbackChildFragment = primaryChildFragment.sibling = createFiberFromFragment(nextFallbackChildren, mode, renderExpirationTime, null);
        ...
        // normally do.
        const nextPrimaryChildren = nextProps.children;
        next = child = reconcileChildFibers(workInProgress, currentPrimaryChild, nextPrimaryChildren, renderExpirationTime);
      }
    }
...
function updateDehydratedSuspenseComponent(current, workInProgress, renderExpirationTime) {
  ...
  if (didReceiveUpdate || hasContextChanged) {
    ...
    current.effectTag = Deletion; // Upgrade this work in progress to a real Suspense component.
