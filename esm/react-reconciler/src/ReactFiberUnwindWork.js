...
import { ClassComponent, HostRoot, HostComponent, HostPortal, ContextProvider, SuspenseComponent, DehydratedSuspenseComponent, IncompleteClassComponent } from "../../react-shared/ReactWorkTags.js";
import { DidCapture, Incomplete, NoEffect, ShouldCapture, LifecycleEffectMask } from "../../react-shared/ReactSideEffectTags.js";
import { enableSchedulerTracing, enableSuspenseServerRenderer } from "../../react-shared/ReactFeatureFlags.js";
...
import { enqueueCapturedUpdate, createUpdate, CaptureUpdate, ForceUpdate, enqueueUpdate } from "./ReactUpdateQueue.js";
...
import { renderDidSuspend, renderDidError, onUncaughtError, markLegacyErrorBoundaryAsFailed, isAlreadyFailedLegacyErrorBoundary, pingSuspendedRoot, retryTimedOutBoundary } from "./ReactFiberScheduler.js";
import invariant from "../../react-shared/invariant.js";
import maxSigned31BitInt from "./maxSigned31BitInt.js";
import { Sync, expirationTimeToMs, LOW_PRIORITY_EXPIRATION } from "./ReactFiberExpirationTime.js";
import { findEarliestOutstandingPriorityLevel } from "./ReactFiberPendingPriority.js";
const PossiblyWeakSet = typeof WeakSet === 'function' ? WeakSet : Set;
const PossiblyWeakMap = typeof WeakMap === 'function' ? WeakMap : Map;

function createRootErrorUpdate(fiber, errorInfo, expirationTime) {
  const update = createUpdate(expirationTime); // Unmount the root by rendering null.
...
function throwException(root, returnFiber, sourceFiber, value, renderExpirationTime) {
  ...
  if (value !== null && typeof value === 'object' && typeof value.then === 'function') {
    // This is a thenable.
    const thenable = value; // Find the earliest timeout threshold of all the placeholders in the
    ...
    } while (workInProgress !== null); // Schedule the nearest Suspense to re-render the timed out view.
    ...
    do {
      if (workInProgress.tag === SuspenseComponent && shouldCaptureSuspense(workInProgress)) {
        ...
        return;
      } else if (enableSuspenseServerRenderer && workInProgress.tag === DehydratedSuspenseComponent) {
        ...
        if (retryCache === null) {
          ...
          const current = workInProgress.alternate;
          invariant(current, 'A dehydrated suspense boundary must commit before trying to render. ' + 'This is probably a bug in React.');
        ...
        if (!retryCache.has(thenable)) {
          ...
          let retry = retryTimedOutBoundary.bind(null, workInProgress, thenable);
...
export { throwException, unwindWork, unwindInterruptedWork, createRootErrorUpdate, createClassErrorUpdate };