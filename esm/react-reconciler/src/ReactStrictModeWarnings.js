...
const ReactStrictModeWarnings = {
  ...
  recordDeprecationWarnings(fiber, instance) {},
...
if (__DEV__) {
  ...
  ReactStrictModeWarnings.flushPendingUnsafeLifecycleWarnings = () => {
    pendingUnsafeLifecycleWarnings.forEach((lifecycleWarningsMap, strictRoot) => {
  ...
  ReactStrictModeWarnings.recordDeprecationWarnings = (fiber, instance) => {
