...
import { registrationNameModules } from "../react-events/EventPluginRegistry.js";
import warning from "../react-shared/warning.js";
import { canUseDOM } from "../react-shared/ExecutionEnvironment.js";
import warningWithoutStack from "../react-shared/warningWithoutStack.js";
import { getValueForAttribute, getValueForProperty, setValueForProperty } from "./DOMPropertyOperations.js";
...
import { getHostProps as ReactDOMOptionGetHostProps, postMountWrapper as ReactDOMOptionPostMountWrapper, validateProps as ReactDOMOptionValidateProps } from "./ReactDOMOption.js";
import { initWrapperState as ReactDOMSelectInitWrapperState, getHostProps as ReactDOMSelectGetHostProps, postMountWrapper as ReactDOMSelectPostMountWrapper, restoreControlledState as ReactDOMSelectRestoreControlledState, postUpdateWrapper as ReactDOMSelectPostUpdateWrapper } from "./ReactDOMSelect.js";
import { initWrapperState as ReactDOMTextareaInitWrapperState, getHostProps as ReactDOMTextareaGetHostProps, postMountWrapper as ReactDOMTextareaPostMountWrapper, updateWrapper as ReactDOMTextareaUpdateWrapper, restoreControlledState as ReactDOMTextareaRestoreControlledState } from "./ReactDOMTextarea.js";
...
import { TOP_ERROR, TOP_INVALID, TOP_LOAD, TOP_RESET, TOP_SUBMIT, TOP_TOGGLE } from "../events/DOMTopLevelEventTypes.js";
...
import { createDangerousStringForStyles, setValueForStyles, validateShorthandPropertyCollisionInDev } from "../shared/CSSPropertyOperations.js";
import { Namespaces, getIntrinsicNamespace } from "../shared/DOMNamespaces.js";
import { getPropertyInfo, shouldIgnoreAttribute, shouldRemoveAttribute } from "../shared/DOMProperty.js";
...
false) {
  ...
  warnForInvalidEventListener = function (registrationName, listener) {
    if (listener === false) {
      ...
      warning(false, 'Expected `%s` listener to be a function, instead got a value of `%s` type.', registrationName, typeof listener);
    }
...
export function createElement(type, props, rootContainerElement, parentNamespace) {
  ...
  if (namespaceURI === HTML_NAMESPACE) {
    ...
    false) {
      ...
      warning(isCustomComponentTag || type === type.toLowerCase(), '<%s /> is using incorrect casing. ' + 'Use PascalCase for React components, ' + 'or lowercase for HTML elements.', type);
    }
...
export function setInitialProperties(domElement, tag, rawProps, rootContainerElement) {
  ...
  false) {
    ...
    if (isCustomComponentTag && !didWarnShadyDOM && domElement.shadyRoot) {
      warning(false, '%s is using shady DOM. Using shady DOM with React can ' + 'cause things to break subtly.', getCurrentFiberOwnerNameInDevOrNull() || 'A component');
