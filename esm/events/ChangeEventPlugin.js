 ...
 */
import { runEventsInBatch } from "../react-events/EventPluginHub.js";
import { accumulateTwoPhaseDispatches } from "../react-events/EventPropagators.js";
import { enqueueStateRestore } from "../react-events/ReactControlledComponent.js";
import { batchedUpdates } from "../react-events/ReactGenericBatching.js";
import SyntheticEvent from "../react-events/SyntheticEvent.js";
import isTextInputElement from "../react-shared/isTextInputElement.js";
import { canUseDOM } from "../react-shared/ExecutionEnvironment.js";
import { TOP_BLUR, TOP_CHANGE, TOP_CLICK, TOP_FOCUS, TOP_INPUT, TOP_KEY_DOWN, TOP_KEY_UP, TOP_SELECTION_CHANGE } from "./DOMTopLevelEventTypes.js";
...
import { disableInputAttributeSyncing } from "../react-shared/ReactFeatureFlags.js";
const eventTypes = {
  change: {
