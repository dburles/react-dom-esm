 ...
 */
import warningWithoutStack from "../react-shared/warningWithoutStack.js"; // TODO: direct imports like some-package/src/* are bad. Fix me.

import { getCurrentFiberStackInDev } from "../react-reconciler/src/ReactCurrentFiber.js";
...
if (__DEV__) {
  ...
  validateDOMNesting = function (childTag, childText, ancestorInfo) {
    ...
    if (childText != null) {
      warningWithoutStack(childTag == null, 'validateDOMNesting: when childText is passed, childTag should be null');
      childTag = '#text';
    }
