...
function updateNamedCousins(rootNode, props) {
  ...
  if (props.type === 'radio' && name != null) {
    ...
    for (let i = 0; i < group.length; i++) {
      ...
      invariant(otherProps, 'ReactDOMInput: Mixing React and non-React radio inputs with the ' + 'same `name` is not supported.'); // We need update the tracked value on the named cousin since the value
